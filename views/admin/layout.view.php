...
<head>
  ...
  <link href="/2LK_Shop/public/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
  <link href="/2LK_Shop/public/css/icons.min.css" rel="stylesheet" type="text/css" />
  <link href="/2LK_Shop/public/css/app.min.css" rel="stylesheet" type="text/css" id="light-style" />
  <link href="/2LK_Shop/public/css/admin.css" rel="stylesheet" type="text/css" />
...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="leftside-menu">
      <!-- LOGO -->
      <a href="/2LK_Shop" class="logo text-center logo-light">
        <span class="logo-lg">
          <img src="/2LK_Shop/public/images/SVG/Logo.svg" alt="" height="30" />
        </span>
        <span class="logo-sm">
          <img src="/2LK_Shop/public/images/SVG/logo-sm.svg" alt="" height="30" />
        </span>
      </a>
      ...
      <div class="h-100" id="leftside-menu-container" data-simplebar="">
        ...
        <ul class="side-nav">
          <li class="side-nav-item">
            <a href="/2LK_Shop/admin" class="side-nav-link">
          ...
          <li class="side-nav-item">
            ...
            <a href="/2LK_Shop/admin/brands" class="side-nav-link">
          ...
          <ul class="list-unstyled topbar-menu float-end mb-0">
            ...
            <li class="dropdown notification-list">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                ...
                <!-- item-->
                <a href="/2LK_Shop/logout" class="dropdown-item notify-item">
  ...
  <script src="/2LK_Shop/public/js/vendor.min.js"></script>
  <script src="/2LK_Shop/public/js/app.min.js"></script>

  <!-- third party js -->
  <script src="/2LK_Shop/public/js/vendor/apexcharts.min.js"></script>
  <script src="/2LK_Shop/public/js/vendor/jquery-jvectormap-1.2.2.min.js"></script>
  <script src="/2LK_Shop/public/js/vendor/jquery-jvectormap-world-mill-en.js"></script>
  <script src="/2LK_Shop/public/js/vendor/jquery.dataTables.min.js"></script>
  <script src="/2LK_Shop/public/js/vendor/dataTables.bootstrap5.js"></script>
  <script src="/2LK_Shop/public/js/vendor/dataTables.responsive.min.js"></script>
  <script src="/2LK_Shop/public/js/vendor/responsive.bootstrap5.min.js"></script>
  <script src="/2LK_Shop/public/js/vendor/dataTables.checkboxes.min.js"></script>
  <!-- third party js ends -->

  <!-- demo app -->
  <script src="/2LK_Shop/public/js/pages/demo.dashboard.js"></script>
</body>
