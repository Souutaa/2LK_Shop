      ...
      <div class="header__container">
        <div class="header__logo">
          <a href="<?php echo $routes->get('homepage')->getPath(); ?>">
            <img src="/2LK_Shop/public/images/page/Logo.svg" alt="Logo 2LK_Shop" class="logo" />
          </a>
        </div>
        ...
        <nav class="nav-user">
          <?php if ($_SESSION['isLoggedIn'] == true): ?>
                    <a class="nav-user__icon-box" href="<?php echo getPath($routes, 'viewCart') ?>">
                      <svg class="icon">
                        <use xlink:href="/2LK_Shop/public/images/SVG/symbol-defs.svg#icon-location-shopping"></use>
                      </svg>
                    </a>
        ...
        <?php if ($_SESSION['isLoggedIn'] == false): ?>
                  ...
                  <a href="/2LK_Shop/register" class="btn btn__secondary btn__secondary--active">Đăng kí</a>
        <?php endif ?>
        </nav>
      </div>
    </header>
        ...
        <div class="footer__left">
          ...
          <div class="socials">
            <a href="#" class="social__icon facebook__icon">
              <svg class="svg--icon">
                <use xlink:href="/2LK_Shop/public/images/svg/symbol-defs.svg#icon-facebook"></use>
              </svg>
            </a>
            <a href="#" class="social__icon instagram__icon"><svg class="svg--icon">
                <use xlink:href="/2LK_Shop/public/images/svg/symbol-defs.svg#icon-instagram-with-circle"></use>
              </svg>
            </a>
            <a href="#" class="social__icon linkedin__icon"><svg class="svg--icon">
                <use xlink:href="/2LK_Shop/public/images/svg/symbol-defs.svg#icon-linkedin"></use>
              </svg>
            </a>
            <a href="#" class="social__icon twitter__icon"><svg class="svg--icon">
                <use xlink:href="/2LK_Shop/public/images/svg/symbol-defs.svg#icon-twitter"></use>
              </svg>
            </a>
          </div>
        </div>
