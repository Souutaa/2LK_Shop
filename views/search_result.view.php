...
<div class="breadcrumb container">
  <a href="/2LK_Shop" class="breadcrumb__link text-color--4 font-size-2">
    <svg class="icon">
  ...
  <div class="search__list">
    <?php foreach ($productList->productList as $product): ?>
      <div class="search__item">
        <img src="/2LK_Shop/public/images/thumbNail/<?php echo $product->getThumbnail() ?>" alt="<?php echo $product->getProductName()?>" class="search__item-img" />
        <div class="search__item-info-box">
          ...
          <a href="/2LK_Shop/product/<?php echo $product->getProductLine()?>" class="btn btn__primary btn__primary--active see-product-detail">
            Xem sản phẩm
          </a>
        </div>
      </div>
